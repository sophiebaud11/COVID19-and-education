...
## milestone 6: make a table of the sampled school districts/counties and some
## key info (i.e. population, proportion of county, covid cases, etc.)
...
* three stages: intro maps, survey of sampled counties, and anlalysis of teacher
survey
...
write_csv(tibble(county_sample), "raw_data/county_samples.csv")
