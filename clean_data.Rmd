...
and each cell has (1 = virtual, 0 = hybrid, -1 = in person - one unit increase
...
exp(intercept OR trump/biden if -1  + Median for predictor*(case per capita number))/(1+exp(intercept OR trump/biden if -1  + Median for predictor*(case per capita number)) this calculates P(Y = 1) (aka fully remote)

ADD DATA FROM FINAL_SAMPLE_BINOMIAL TO SAMPLES TAB OF SHINY APP
